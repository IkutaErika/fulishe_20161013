   ...
   //     }
    ...
    class CatFilterAdapter extends BaseAdapter {
        ...
        public View getView(int position, View layout, final ViewGroup parent) {
            ...
            final String imgUrl=child.getImageUrl();
            ...
            holder.layoutItem.setOnClickListener(new OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    Intent intent=new Intent(mContext, Category_child_details.class);
                    Bundle bundle=new Bundle();
                    bundle.putString("childsname", child.getName());
                    bundle.putInt("childsid",child.getId());
                    bundle.putSerializable("childs",Children);
